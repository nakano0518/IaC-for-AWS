resource "aws_db_instance" "techbooklabov1-db-instance" {
	...
	parameter_group_name       = aws_db_parameter_group.techbooklabov1-db-param.name 
	option_group_name          = aws_db_option_group.techbooklabov1-db-option.name
